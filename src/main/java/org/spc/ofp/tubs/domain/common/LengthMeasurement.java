 ...
 */
@Entity
@Table(name = "[obsv].[ref_len]")
public class LengthMeasurement implements java.io.Serializable {

	
    /**
	 * 
	 */
	private static final long serialVersionUID = -6249114529177161991L;

	@Id
    @Column(name = "len_code", length = 2)
    private String code;
    
    @Column(name = "len_desc")
    @NotNull
    @Size(max = 40)
